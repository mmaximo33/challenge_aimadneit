...
class BestOfferFinder
{
    ...
    private function prepareElementToEvaluate($offers){
        ...
        foreach ($offers as $offer) {
            ...
            $elementsToEvaluate['isOffer'][$xId]            = ($priceTotal < $this->productOriginalPrice);
        }

        $isOffers = array_merge($elementsToEvaluate, array_values($elementsToEvaluate['isOffer']));

        if(!in_array(true, array_values($isOffers), true)){
